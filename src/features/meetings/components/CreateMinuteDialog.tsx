...
export function CreateMinuteDialog({ meetingId, open, onOpenChange, onSubmit, isPending }: CreateMinuteDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        ...
        <form onSubmit={handleSubmit}>
                    ...
                    <div key={index} className="flex items-start gap-2 border border-hairline p-3">
                      <div className="flex-1 space-y-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Input
                            type="date"
                            value={typeof item.dueDate === "string" ? item.dueDate : item.dueDate ? new Date(item.dueDate).toISOString().split("T")[0] : ""}
          ...
          <DialogFooter>
            <Button type="button" variant="outline" onClick={() => { onOpenChange(false); form.reset(); setActionItems([]); }}>
              Cancel
            </Button>

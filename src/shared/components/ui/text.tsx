...
const textVariants = cva("", {
  variants: {
    variant: {
      "display-mega":
        "font-heading text-[80px] leading-[1.0] tracking-[-2px] font-normal",
      "display-xl":
        "font-heading text-[64px] leading-[1.0] tracking-[-1.6px] font-normal",
      "display-lg":
        "font-heading text-[52px] leading-[1.0] tracking-[-1.3px] font-normal",
      "display-md":
        "font-heading text-[44px] leading-[1.09] tracking-[-1px] font-normal",
...
function Text({
  ...
  return (
    <Comp
      ...
      className={cn(
        textVariants({ variant, color, align, transform }),
        className,
      )}
      {...props}
    />

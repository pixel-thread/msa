    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 text-gray-900">
      <header className="fixed top-0 w-full p-6 flex justify-between items-center max-w-7xl mx-auto">
        ...
        {user ? (
          <Link
            href="/dashboard"
            className="bg-indigo-600 text-white px-4 py-2 font-medium hover:bg-indigo-700 transition"
          >
            Dashboard
          </Link>
        ) : (
      ...
      <main className="text-center px-4 max-w-3xl">
        ...
        <div className="mt-10 flex gap-4 justify-center">
          <Link
            href="/sign-up"
            className="bg-indigo-600 text-white px-8 py-3 text-lg font-bold hover:bg-indigo-700 transition shadow-lg"
          >
            Join Now
          </Link>
          <Link
            href="/sign-in"
            className="bg-white text-indigo-600 border border-indigo-600 px-8 py-3 text-lg font-bold hover:bg-indigo-50 transition"
          >
            Member Portal
          </Link>
        </div>
